...
\subtitle{Techniques Pr\'edictives -- mini Projet de Module}
\author[Bellatreche \& Rezaiguia]{Mohamed Amine \textsc{Bellatreche} \and Soltane \textsc{Rezaiguia}}
...
\begin{center}
\includegraphics[width=0.92\textwidth,height=0.75\textheight,keepaspectratio]{diagrams/01_stacking_architecture.drawio.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.92\textwidth,height=0.75\textheight,keepaspectratio]{diagrams/03_methodology_workflow.drawio.png}
\end{center}
\end{frame}
...
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{output/roc_curves_ames.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[c]
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{output/accuracy_comparison_ames.png}
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{output/corrplot_ames.png}
\end{column}
\end{columns}
\smallskip
\centering\small
...
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{output/roc_curves_pima.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[c]
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{output/accuracy_comparison_pima.png}
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{output/corrplot_pima.png}
\end{column}
\end{columns}
\smallskip
\centering\small
...
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{output/roc_curves_bank_marketing.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[c]
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{output/accuracy_comparison_bank_marketing.png}
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{output/corrplot_bank_marketing.png}
\end{column}
\end{columns}
\smallskip
\centering\small
...
\begin{center}
\includegraphics[width=0.95\textwidth,height=0.74\textheight,keepaspectratio]{diagrams/02_results_comparison.drawio.png}
\end{center}
\end{frame}
...
\begin{columns}[c]
\begin{column}{0.55\textwidth}
\includegraphics[width=\textwidth,height=0.60\textheight,keepaspectratio]{output/comparison_gains.png}
\end{column}
\begin{column}{0.42\textwidth}
\small
\begin{table}[h]
...
\begin{center}
\includegraphics[width=0.92\textwidth,height=0.70\textheight,keepaspectratio]{output/comparison_correlations.png}
\end{center}
\smallskip
\centering\small
...
\begin{center}
\includegraphics[width=0.90\textwidth,height=0.66\textheight,keepaspectratio]{diagrams/05_correlation_vs_performance.drawio.png}
\end{center}
\medskip
\centering\small
...
\begin{center}
\includegraphics[width=0.90\textwidth,height=0.68\textheight,keepaspectratio]{output/oof_distributions_ames.png}
\end{center}
\smallskip
\centering\small
...
\begin{tabular}{l r r r}
\toprule
\textbf{Dataset} & \textbf{OOF} & \textbf{Blending} & \textbf{$\Delta$ (pp)} \\
\midrule
Ames Housing & 0.9453 & 0.9368 & \textcolor{stackgreen}{+0.85} \\
Pima Diabetes & 0.7320 & 0.7516 & \textcolor{stackred}{$-$1.96} \\
Bank Marketing & 0.9034 & 0.9024 & \textcolor{stackgreen}{+0.10} \\
\midrule
\textbf{Moyenne} & 0.8602 & 0.8636 & \textcolor{stackred}{$-$0.34} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
\includegraphics[width=0.92\textwidth,height=0.74\textheight,keepaspectratio]{diagrams/04_key_findings.drawio.png}
\end{center}
\end{frame}
...
\vfill
\small
Mohamed Amine \textsc{Bellatreche} \& Soltane \textsc{Rezaiguia}\\
